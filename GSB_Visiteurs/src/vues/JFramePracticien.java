 ...
 * @author btssio
 */
public class JFramePracticien extends javax.swing.JFrame {

    /**
     * Creates new form JFrameVisiteur
     */
    public JFramePracticien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBoxChercher.setBounds(320, 130, 100, 20);
        jPanel1.add(jTextFieldCoefNotoriete);
        jTextFieldCoefNotoriete.setBounds(270, 340, 110, 20);
        ...
        jButtonOk.setBounds(430, 130, 80, 23);
        ...
        jLabelChercherPracticien.setText("Practicien");
        ...
        jComboBoxLieuExercice.setBounds(270, 380, 110, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramePracticien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFramePracticien().setVisible(true);
            }
        });
    }
